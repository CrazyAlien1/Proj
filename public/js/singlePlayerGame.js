...
/* harmony export (immutable) */ __webpack_exports__["default"] = createOfflineGame;
function createOfflineGame(ID, name, rows, cols, images) {

    var boardSize = validateBoardSize(rows, cols, images.length);
